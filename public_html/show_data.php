    ...
    <div class="container-fluid py-4 px-md-5">
        ...
        <div class="header-box">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div>
                    <h2 class="fw-bold mb-1"><i class="bi bi-water me-2"></i>ระบบแสดงข้อมูลผู้โดยสารเรือไททานิค (Titanic
                        Dataset)</h2>
                    <p class="mb-0 opacity-75">ดึงข้อมูลผ่าน <strong>PHP Data Objects (PDO)</strong> ร่วมกับ MariaDB
                        Database</p>
                </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold text-success mb-0">
                                <?= number_format($stats['survived']) ?> คน
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                <form method="GET" action="show_data.php" class="row g-3 align-items-end">
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold text-secondary">ค้นหา (ชื่อผู้โดยสาร, ตั๋ว,
                            ห้องพัก)</label>
                        <div class="input-group">
                            <span class="input-group-text bg-white"><i class="bi bi-search"></i></span>
                            <input type="text" name="search" class="form-control" placeholder="พิมพ์ชื่อผู้โดยสาร..."
        ...
        <div class="table-container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="fw-bold mb-0 text-dark">
                    ...
                    <span class="badge bg-light text-dark border ms-2">พบ
                        <?= number_format($totalRecords) ?> รายการ
                    </span>
                </h5>
                            ...
                            <?php foreach ($passengers as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="text-muted small">ญาติ/พี่น้อง:
                                            <?= htmlspecialchars($row['SibSp'] ?? 0) ?> | บิดามารดา/บุตร:
                                            <?= htmlspecialchars($row['Parch'] ?? 0) ?>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        if ($emb === 'S')
                                            echo '<span title="Southampton">Southampton (S)</span>';
                                        elseif ($emb === 'C')
                                            echo '<span title="Cherbourg">Cherbourg (C)</span>';
                                        elseif ($emb === 'Q')
                                            echo '<span title="Queenstown">Queenstown (Q)</span>';
                                        else
                    ...
                    <ul class="pagination">
                        ...
                        for ($i = $startPage; $i <= $endPage; $i++):
                            ...
                            <li class="page-item <?= ($i == $page) ? 'active' : '' ?>">
                                <a class="page-link" href="<?= $urlPrefix . $i ?>">
                                    <?= $i ?>
                                </a>
                            </li>
                        <?php endfor; ?>
        ...
        <div class="text-center text-muted small mt-4">
            &copy;
            <?= date('Y') ?> Titanic Data Explorer | Powered by PHP PDO & Nginx Docker
        </div>
